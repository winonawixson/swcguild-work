        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h3>Edit Post</h3>
                    <sf:form method="POST" action="editPost" role="form" class="form-vertical" modelAttribute="postToEdit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <sf:input type="text" class="col-md-8 form-control" id="author" path="author"/>
                            </div>
                        </div>
                        <div class="form-group" >
                        ...
                        <div class="col-md-12">
                            <sf:textarea path="postContent"></sf:textarea>
                        </div>

                        <div class="form-group">
                            <label for="Category" class="col-md-12 control-label post-label">Category:</label>
                            <div class="col-md-4">
                                <sf:input type="text" class="col-md-8 form-control" id="add-category" path="category.category" name="category" required="required"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 post-label">
                                ...
                                <button type="submit" id="save-post" class="btn btn-primary">Save</button>
                            </div>
                        </div>                            
                    </sf:form>
                </div>
